...
We applied our proposed \ac{ml} \ac{irlv} technique also on a real dataset, available in \cite{MOMENTUM-D53}. We show the new numerical results in Fig. \ref{fig:Berlin} and added a paragraph in Section \ref{sec:res_fading} which reads:
\begin{quote}
	"\revp{Berlin}"
\end{quote}
