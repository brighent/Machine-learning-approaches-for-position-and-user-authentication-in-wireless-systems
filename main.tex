...
\end{enumerate}
In particular, about point 1)  we revised the entire Section  Section \ref{sec:los} in order to include more realistic scenarios and show the effect of the different channel parameters on the \ac{irlv} performance. In particular we added in Section \ref{sec:los}
\begin{quote}
"\revp{simpleScen}
