...
\setstretch{1.5}
{\bf Ans}: We thank the reviewer for pointing out the issue. We have dropped the adjective {\it fixed} in favour of clearer statements in Section~\ref{sec:nn} and \ref{sec:svm} which now read:
\begin{quote}
	"\revp{hyper1}"
\end{quote}
and
