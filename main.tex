...
\begin{figure}[t]
    ...
    \caption{\ac{roc} of \ac{irlv} methods for different values of training-set size $S$. Environment of Fig. \ref{fig:mBS}, with  $N_{\rm AP}=10$, $d_1 = 100$ m and $d_2 = 225$ m, $\sigma_{s,{\rm dB}} = $\hl{...}. \colorbox{red}{TAGLIAMO A PFA=$10^{-2}$.}}
